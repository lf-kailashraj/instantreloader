...
import org.lftechnology.outlier.instantreloader.transformer.InstantClassTransformer;
			...
			return new MethodVisitor(Opcodes.ASM4, methodVisitor) {
				...
				public void visitCode() {
					...
					mv.visitMethodInsn(Opcodes.INVOKESTATIC,
							Type.getInternalName(InstantReloader.class),
					...
					mv.visitMethodInsn(
							...
							Type.getInternalName(InstantClassTransformer.class),
							"transform",
